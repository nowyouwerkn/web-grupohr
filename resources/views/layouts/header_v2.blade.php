    ...
    <div class="container">
        <div class="row align-items-center justify-content-end">
            ...
            <div class="col col-md-4 text-center">
                <a class="logo hide-text" href="{{ route('index') }}">Grupo HR</a>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <button onclick="toggleMenu()" class="btn btn-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="10" viewBox="0 0 28 10" fill="none">
                            <path d="M27.4286 1H0" stroke="#1C1917" stroke-width="0.857143"/>
                            <path d="M27.4286 7.85693H0" stroke="#1C1917" stroke-width="0.857143"/>
                        </svg>
