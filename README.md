...
```
sudo apt-get install curl php8.2-curl php8.2-xml php8.2-gd php8.2-opcache php8.2-mbstring php8.2-zip
...
```
cd /var/www/html
git clone https://github.com/nowyouwerkn/web-grupohr 
```
